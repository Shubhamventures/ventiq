  ...
  return (
    <main>
      ...
      <style>{`
        ...
        /* =========================================================
           W1G4.1 — CENTERED HERO REBALANCE
           Keep the proven headline. Add horizontal proof, reduce
           poster-like scale, and pull the signature section forward.
        ========================================================= */
        ...
        .w1g41-hero .w1a-eyebrow {
          margin-bottom: 22px !important;
        }

        .w1a-hero .w1g41-title {
        ...
        .w1g41-proof-item:first-child {
          padding-left: 6px;
        }

        .w1g41-proof-item:last-child {
          padding-right: 6px;
          border-right: 0;
        }
        ...
        .w1g41-proof-item div {
          display: grid;
          gap: 5px;
        }

        .w1g41-proof-item strong {
          color: #f2f6ff;
          font-size: 12px;
          line-height: 1.2;
          font-weight: 850;
        ...
        .w1g41-proof-item div > span {
          color: #9eb0ca;
          font-size: 13px;
          line-height: 1.45;
        }

        .w1g41-hero + .w1b-section {
          margin-top: 0 !important;
        }
      ...
      <div className="container">
        ...
        <section className="w1a-hero w1a-hero-centered w1g41-hero" aria-labelledby="ventiq-hero-title">
          <div className="w1a-hero-copy w1a-hero-copy-centered w1g41-hero-copy">
            <div className="w1a-eyebrow">
              <span className="w1a-eyebrow-dot" aria-hidden="true" />
              One fund · Six stakeholders · One source of truth
            </div>

            <h1 id="ventiq-hero-title" className="w1a-centered-title w1g41-title">
            ...
            <p className="w1a-hero-lede w1a-centered-lede w1g41-lede">
              One governed fund layer powering role-native data, workflows, approvals
              and AI context across the private-capital firm.
            </p>

            <div className="w1a-hero-actions w1a-centered-actions w1g41-actions">
              <button
            ...
            <a className="w1a-private-walkthrough w1a-hero-scroll-cue w1g41-scroll-cue" href="#modules">
              Explore how VENTIQ works
              <span aria-hidden="true">↓</span>
            </a>

            <div className="w1g41-proof-rail" aria-label="VENTIQ platform principles">
              <div className="w1g41-proof-item">
                <span className="w1g41-proof-mark" aria-hidden="true" />
                <div>
