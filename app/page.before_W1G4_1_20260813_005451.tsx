  ...
  return (
    <main>
      ...
      <div className="container">
        ...
        <section className="w1a-hero w1a-hero-centered" aria-labelledby="ventiq-hero-title">
          <div className="w1a-hero-copy w1a-hero-copy-centered">
            <div className="w1a-eyebrow">
              <span className="w1a-eyebrow-dot" aria-hidden="true" />
              One fund · Six stakeholders · One source of truth
            </div>

            <h1 id="ventiq-hero-title" className="w1a-centered-title">
              <span>Private capital,</span>
              <span>
                run as <span className="w1a-gradient-text">one system.</span>
              </span>
            </h1>

            <p className="w1a-hero-lede w1a-centered-lede">
              VENTIQ connects fund data, workflows, governance and stakeholder
              experiences through one governed operating layer built for private capital.
            </p>

            <div className="w1a-hero-actions w1a-centered-actions">
              <button
            ...
            <a className="w1a-private-walkthrough w1a-hero-scroll-cue" href="#modules">
