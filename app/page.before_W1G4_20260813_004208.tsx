...
export default function Home() {
  ...
  const [heroPreview, setHeroPreview] = useState<"launch" | "investor" | "dataRoom">("launch");
  ...
  const heroPreviewConfig = {
    launch: {
      eyebrow: "Governed launch",
      title: "Six stakeholder views ready",
      image: "/website/ventiq-hero-stakeholder-launch-focus.png",
      alt: "VENTIQ Stakeholder Launch Center showing all six stakeholder experiences ready",
      proofLabel: "Launch gate",
      proofValue: "6 / 6 READY",
    },
    investor: {
      eyebrow: "Investor experience",
      title: "Verified role-native LP access",
      image: "/website/ventiq-hero-investor-portal-focus.png",
      alt: "VENTIQ Investor Portal showing governed investor financial access",
      proofLabel: "Reconciliation",
      proofValue: "11 / 11 PASSED",
    },
    dataRoom: {
      eyebrow: "Investor relations",
      title: "Governed document sharing",
      image: "/website/ventiq-hero-data-room-focus.png",
      alt: "VENTIQ Investor Data Room and DDQ Hub",
      proofLabel: "Activation",
      proofValue: "ACTIVE · 100%",
    },
  }[heroPreview];
    ...
    <main>
      ...
      <div className="container">
        <header className="w1f2-site-header">
          ...
          <nav className="w1f2-site-nav" aria-label="Primary navigation">
            <a href="#why-ventiq">Why VENTIQ</a>
            <a href="#modules">Stakeholders</a>
            <a href="#platform-breadth">Platform</a>
        ...
        <section className="w1a-hero" aria-labelledby="ventiq-hero-title">
          <div className="w1a-hero-copy">
            <div className="w1a-eyebrow">
              <span className="w1a-eyebrow-dot" aria-hidden="true" />
              One fund · Six stakeholders · One source of truth
            </div>

            <h1 id="ventiq-hero-title">
              <span>AI Stakeholder</span>
              <span>Dashboards for</span>
              <span className="w1a-gradient-text">Private Capital</span>
            </h1>

            <p className="w1a-hero-lede">
              VENTIQ turns one governed fund layer into six role-native
              experiences — with the data, approvals, workflows and AI context
              each stakeholder needs.
            </p>

            <div className="w1a-hero-actions">
              <button
            ...
            <a className="w1a-private-walkthrough" href="#modules">
              Explore the six stakeholder experiences
              <span aria-hidden="true">→</span>
            </a>
          </div>

          <div className="w1a-hero-visual" aria-label="Real VENTIQ product experiences">
            <div className="w1a-stage-glow w1a-stage-glow-one" />
            <div className="w1a-stage-glow w1a-stage-glow-two" />

            <div className="w1a-product-stage">
              <div className="w1a-stage-topline">
                <div>
                  <span className="w1a-live-dot" aria-hidden="true" />
                  <strong>VENTIQ product</strong>
                </div>
                <span>Real product · Switch the experience</span>
              </div>

              <div className="w1a-preview-switcher" aria-label="Choose a real VENTIQ product view">
                {(["launch", "investor", "dataRoom"] as const).map((previewKey) => {
                  const previewLabel = {
                    launch: "Stakeholder Launch",
                    investor: "Investor Portal",
                    dataRoom: "Data Room & DDQ",
                  }[previewKey];

                  return (
                    <button
                      key={previewKey}
                      className={heroPreview === previewKey ? "active" : ""}
                      type="button"
                      onClick={() => setHeroPreview(previewKey)}
                    >
                      {previewLabel}
                    </button>
                  );
              ...
              <div className="w1a-stage-screens">
                <figure className="w1a-screen-card w1a-screen-main">
                  <figcaption>
                    <span>{heroPreviewConfig.eyebrow}</span>
                    <strong>{heroPreviewConfig.title}</strong>
                  </figcaption>
                  <div className="w1a-screen-crop">
                    <img src={heroPreviewConfig.image} alt={heroPreviewConfig.alt} />
                  </div>
                  <div className="w1a-proof-badge">
                    <span>{heroPreviewConfig.proofLabel}</span>
                    <strong>{heroPreviewConfig.proofValue}</strong>
                  </div>
                </figure>
              </div>
        ...
        <section className="w1c-section" id="why-ventiq">
          <div className="w1c-kicker">
            <span>THE VENTIQ OPERATING LAYER</span>
            <div />
            <span>FRAGMENTED IN · GOVERNED OUT</span>
          </div>

          <div className="w1c-heading-row">
            <h2>
              <span>From fragmented fund</span>
              <span>operations to one</span>
              <span>governed fund layer.</span>
            </h2>

            <p>
              VENTIQ connects fund, investor, portfolio, document and workflow
              activity into one governed operating layer — so every stakeholder
              works from the same fund, but sees the information, approvals and
              actions relevant to their role.
            </p>
          </div>

          <div className="w1c-flow-shell">
            <div className="w1c-zone w1c-input-zone">
              <div className="w1c-zone-head">
                <span>01 · BEFORE VENTIQ</span>
                <strong>Fragmented operating inputs</strong>
                <p>
                  Critical fund information arrives from different systems,
                  people and formats.
                </p>
              </div>

              <div className="w1c-input-list">
                <div className="w1c-source-node">
                  <span>STRUCTURED</span>
                  <strong>Spreadsheets & MIS</strong>
                  <small>Fund · investor · cashflow · valuation</small>
                </div>

                <div className="w1c-source-node">
                  <span>COMMUNICATION</span>
                  <strong>Email threads</strong>
                  <small>Approvals · LP updates · follow-ups</small>
                </div>

                <div className="w1c-source-node">
                  <span>SERVICE PROVIDERS</span>
                  <strong>Fund admin outputs</strong>
                  <small>NAV · statements · reconciliations</small>
                </div>

                <div className="w1c-source-node">
                  <span>DOCUMENTS</span>
                  <strong>PDFs & shared folders</strong>
                  <small>Notices · reports · tax forms · evidence</small>
                </div>

                <div className="w1c-source-node">
                  <span>CONTROL</span>
                  <strong>Compliance trackers</strong>
                  <small>Due dates · filings · evidence gaps</small>
                </div>

                <div className="w1c-source-node">
                  <span>PORTFOLIO</span>
                  <strong>Company updates</strong>
                  <small>Performance · risk · exits · repayment</small>
                </div>
              </div>

              <div className="w1c-flow-caption">
                <i />
                Different versions of the fund
              </div>
            </div>

            <div className="w1c-core-zone">
              <div className="w1c-core-orbit">
                <span className="w1c-orbit-badge badge-one">Maker-checker</span>
                <span className="w1c-orbit-badge badge-two">Role access</span>
                <span className="w1c-orbit-badge badge-three">Audit evidence</span>

                <div className="w1c-core-card">
                  <div className="w1c-core-topline">
                    <span>02 · VENTIQ FUND CORE</span>
                    <strong>
                      <i />
                      Governed
                    </strong>
                  ...
                  <div className="w1c-core-brand">
                    <span>VENTIQ</span>
                    <strong>One operating layer</strong>
                    <p>
                      Ingest → validate → approve → activate → serve
                    </p>
                  </div>

                  <div className="w1c-pipeline">
                    <div>
                      <span>01</span>
                  ...
                  <div className="w1c-core-footer">
                    <span>CANONICAL FUND CONTEXT</span>
                    <strong>One source of truth underneath every experience</strong>
                  </div>
                </div>
              </div>
            </div>

            <div className="w1c-zone w1c-output-zone">
              <div className="w1c-zone-head">
                <span>03 · WITH VENTIQ</span>
                <strong>Six role-native experiences</strong>
                <p>
                  The same governed fund becomes the right working view for
                  every stakeholder.
                </p>
              </div>

              <div className="w1c-output-list">
                <a href="/managing-partner-ai">
                  <span>01</span>
                  <div>
                    <strong>Managing Partner</strong>
                    <small>Performance · portfolio · LP narrative</small>
                  </div>
                  <i>↗</i>
                </a>

                <a href="/finance-head-ai">
                  <span>02</span>
                  <div>
                    <strong>Finance Head</strong>
                    <small>Capital movement · notices · approvals</small>
                  </div>
                  <i>↗</i>
                </a>
                ...
                <a href="/compliance-ai">
                  ...
                  <div>
                    ...
                    <small>Filings · evidence · regulatory actions</small>
                  </div>
                  <i>↗</i>
                </a>

                <a href="/investment-team-ai">
                  <span>04</span>
                  <div>
                    <strong>Investment Team</strong>
                    <small>Portfolio movement · risk · exits</small>
                  </div>
                  <i>↗</i>
                </a>

                <a href="/fundraising-ai">
                  <span>05</span>
                  <div>
                    <strong>Investor Relations</strong>
                    <small>LP communication · DDQ · fundraising</small>
                  </div>
                  <i>↗</i>
                </a>
                ...
                <a href="/investor-portal">
                  <span>06</span>
                  <div>
                    <strong>Investor / LP</strong>
                    <small>Financials · cashflows · documents</small>
                  </div>
                  <i>↗</i>
                </a>
              </div>

              <div className="w1c-flow-caption w1c-flow-caption-right">
                <i />
                One governed fund · permission-aware output
              </div>
            </div>
          </div>

          <div className="w1c-proof-strip">
            <div>
              <span>01</span>
              <strong>One governed fund data layer</strong>
              <p>Structured and unstructured information comes into one fund context.</p>
            </div>

            <div>
              <span>02</span>
              <strong>Permission-aware visibility</strong>
              <p>Each stakeholder sees only the fund information relevant to their role.</p>
            </div>

            <div>
              <span>03</span>
              <strong>Controls and evidence stay attached</strong>
              <p>Maker-checker, approvals and audit history travel with the workflow.</p>
            </div>

            <div>
              <span>04</span>
              <strong>AI stays inside the same context</strong>
              <p>Opinions and actions are grounded in the connected operating layer.</p>
            </div>
          </div>
        </section>
        ...
        <section className="w1f2-product-section" id="guided-demo">
          ...
          <div className="w1f2-product-heading">
            <h2>From fund intake to investor access. Inside VENTIQ.</h2>
            <p>
              One connected journey, shown one stage at a time. Follow governed
              fund data from intake and approval through investor outputs and
              entitled access.
            </p>
          </div>
          ...
          <div className="w1f2-platform-grid">
            ...
            <div className="w1f2-platform-group foundation">
              ...
              <div className="w1f2-platform-items">
                ...
                <a href="/document-studio"><strong>Investor Document Status</strong><span>Generation · publishing · delivery state</span><i>↗</i></a>
              </div>
            </div>
        ...
        <section className="w1e-about-section w1g-about-section" id="about">
          <div className="w1e-about-copy">
            ...
            <p>
              Private capital teams still rebuild the same fund truth across
              spreadsheets, service-provider outputs, inboxes and reporting
              cycles. VENTIQ is being built to turn that fragmented operating
              reality into one governed fund layer.
            </p>

            <p>
              The product starts from the work itself — fund operations,
              investor reporting, approvals, controls and stakeholder access —
              rather than adding another disconnected dashboard on top.
            </p>
        ...
        <section className="w1e-final-section w1g-final-section" id="contact">
          ...
          <div className="w1e-final-content">
            ...
            <p>
              Walk through the connected journey from fund intake and governance
